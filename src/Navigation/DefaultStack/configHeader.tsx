...
const Header = () => <Image style={{ width: 90, height: 43 }} source={require('../../assets/images/logo-flipp.png')} />;
  ...
  if (navigation)
    props.headerRight = ({ tintColor }) => (
      <TouchableOpacity onPress={() => navigation.navigate('Configuration')}>
        <Ionicons name="md-settings-sharp" size={30} color={tintColor} style={{ paddingRight: 15 }} />
      </TouchableOpacity>
    );
